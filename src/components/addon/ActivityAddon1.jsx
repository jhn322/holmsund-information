...
import { activitySlides1 } from "../data/ActivityAddonSet";
...
const Carousel = () => {
  ...
  const handlePrev = () => {
    setActiveIndex((prevIndex) =>
      prevIndex === 0 ? activitySlides1.length - 1 : prevIndex - 1
    );
    setDeltaX(0);
  };
  ...
  const handleNext = () => {
    setActiveIndex((prevIndex) =>
      prevIndex === activitySlides1.length - 1 ? 0 : prevIndex + 1
    );
    setDeltaX(0);
  };
    ...
    >
      <main className={styles.container}>
        <div className={styles.carouselInner}>
          ...
          >
            {activitySlides1.map((slide, index) => (
              <figure
                key={index}
                  ...
                  >
                    <div className={styles.imgContainer}>
                      ...
                      <div className={styles.slideCounter}>
                        {index + 1}/{activitySlides1.length}
                      </div>
                    </div>
                  </a>
                )}
