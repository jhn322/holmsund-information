...
import { discoverAddonSet2 } from "../data/DiscoverAddonSet";
...
const DiscoverAddon2 = ({ title }) => {
  ...
  const [overlayStates, setOverlayStates] = useState(
    Array(discoverAddonSet2.length).fill(false)
  );
  ...
  useEffect(() => {
    const index = discoverAddonSet2.findIndex(
      (card) => card.link === currentPath
    );
    setCurrentPathIndex(index);
  }, [currentPath, discoverAddonSet2]);
